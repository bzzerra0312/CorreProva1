...
public class BDSimulado {
	...
	public BDSimulado(ArrayList<Cliente> clientes, ArrayList<Ligacao> ligacoes) {
		...
		for (int i = 0; i < this.clientes.size(); i++) {
			if (this.clientes.get(i).getNome().equals(nome)) {
				resultado = "Nome: " + this.clientes.get(i).getNome() +
						    ...
						    "\n" +
						    "Data de nascimento: " + this.clientes.get(i).getDN() +
						    "\n" +
						    "Número de telefone: " + this.clientes.get(i).getNT() +
						    "\n" + 
